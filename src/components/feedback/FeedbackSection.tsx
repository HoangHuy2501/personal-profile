...
function feedbackError(error: unknown, copy: any, fallback: string) {
  ...
  if (code.includes("10-2000") || code.includes("10–2000"))
    return copy.errors.validation;
  if (code === "feedback_reply_required" || code === "Enter a reply.")
    return copy.replyRequired;
  if (
    code === "reply" ||
    code === "reply_submit" ||
    code === "reply_expired" ||
  ...
  return (
    ...
    >
            ...
            items.map((item, index) => (
              ...
              >
                ...
                {item.replies.map((itemReply) => (
                  <div className="feedback-reply" key={itemReply.id}>
                    <strong>
                      {itemReply.authorKey === "owner" || !itemReply.author
                        ? copy.owner
                        : itemReply.author}
                    </strong>
      ...
      <PasswordDialog
        ...
        description={copy.replyDescription}
        onClose={() => {
          setPasswordOpen(false);
          setReplyFor(null);
        }}
